			...
			function formulary_festival() 	
				...
				function formulary_dias() 	
				{
				   ...
				   $consultabd=$this->consulta_model->buscar_d();
					...
					$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9,1,'EMAIL DEL RESPONSABLE');
					$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10,1,'EMAIL DEL VICE-RESPONSABLE');
					$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11,1,'TOTAL DE PARTICPANTES');
					$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12,1,'FECHA DE INSCRIPCION');
					//$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11,1,'TEL. EMERGENCIA');
					//$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12,1,'PADECE ENFERMEDAD');
					//$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13,1,'FECHA DE INSCRI.');
					$fila=2;
					...
					foreach ($consultabd->result() as $row) {
						...
						$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( 9,$fila ,$row->email_resp);
						$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( 10,$fila ,$row->email_vice);
					    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( 11 ,$fila ,$row->total_parti);
						$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( 12,$fila ,$row->fecha_creacion);
						 //$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( 11,$fila ,$row->etel);
						 //$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( 12,$fila ,$row->enfermedad);
						 //$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow( 13,$fila ,$row->fecharegis);
