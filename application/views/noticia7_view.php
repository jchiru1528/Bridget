    ...
    <div  class="grey-content">		
            ...
            <div class="container">
                ...
                <div class="templatemo-slogan text-center">
                    ...
                    <h1><P ALIGN=center><b>PRESENCIA DE LA JORNADA MUNDIAL DE LA JUVENTUD -  DIOCESIS DE COLÓN – KUNA YALA EN LA FERIA DE COLÓN.<b>  </p> </h1>
					<P ALIGN=center>
						  <img src="<?php echo base_url();?>images/noticias/noticia_7.png" class="img-responsive" ALIGN=center alt="gallery" />
                     </p>
					<h4>
					<h2  style="color:#fff" align="justify">
							El Patronato de la Feria de Colón invitó a la Comisión Diocesana de la JMJ- Colón Kuna Yala a participar en su XXXII Feria
							Nacional de Colón, que consistió en una ventana turística, folklórica, artística y gastronómica, la cual se realizó en el 
							Corregimiento de Buena Vista, del 4 al 15 de abril del presente año.
                     </h2>
                     <h2  style="color:#fff" align="justify">
							La Feria fue inaugurada el 4 de abril con la participación de Monseñor Manuel Ochogavía Barahona, miembros de la Comisión 
							Diocesana JMJ, voluntarios y miembros de diferentes grupos juveniles.
                     </h2>
					 
					  <h2  style="color:#fff" align="justify">
							La Comisión Diocesana participó con su stand, donde tuvo la oportunidad de presentar videos de la JMJ, de la Diócesis,
							hacer sus anuncios publicitarios  y vender sus  artículos promocionales. El público que atendieron se sintió muy 
							complacido y motivado a participar durante los días en las Diócesis, que será del 14 al 21 de enero de 2019, 
							a hospedar peregrinos y a ser voluntarios. 
                    
				     
					  </h2>
					   <h2  style="color:#fff" align="justify">
							Los jóvenes animaron durante todos los días de la feria a sus asistentes a participar de manera activa en este evento, 
							que tendrá muchas atracciones para nacionales y extranjeros, ya que será de gran enriquecimiento para nuestra provincia.
