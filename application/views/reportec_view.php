				  ...
				  <?php foreach($datos->result() as $row){?>
		                 <div class="row">
							...
							<div class="row">
								<div class="form-group">
									<div class="col-lg-3">
									 ...
									 <div class="col-lg-7">
										<input name="nombre" type="text" class="form-control" id="nombre" placeholder="Nombre del Cantante o Grupo " value ="<?php   echo $row->nombre."  " ?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									<div class="col-lg-3">
									 ...
									 <div class="col-lg-7">
										<input name="contacto" type="text" class="form-control" id="contacto" placeholder="Persona De Contacto " value ="<?php   echo $row->contacto."  " ?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									<div class="col-lg-3">
									 ...
									 <div class="col-lg-7">
										<input name="miembros" type="text" class="form-control" id="miembros" placeholder="Total De Miembros  " maxlength="45" value ="<?php   echo $row->total."  " ?>">
									</div>
								</div>
							</div>
							<div class="row">
									 ...
									 <div class="col-lg-7">
										<input name="direc" type="text" class="form-control col-sm-1"  id="direc" placeholder="Dirección (País, Provincia)" value ="<?php   echo $row->domicilio."  " ?>">
									</div>
							</div>
							...
							<div class="row">
									 ...
									 <div class="col-lg-4">
										<input name="telefono1" type="text" class="form-control col-sm-1"  id="telefono1" placeholder="Telefono 1" value ="<?php   echo $row->telefono1."  " ?>"> 	
									</div>
									<div class="col-lg-3">
										<input name="telefono1" type="text" class="form-control col-sm-1"  id="telefono1" placeholder="Telefono 2" value ="<?php   echo $row->telefono2."  " ?>">   	
									</div>
							</div>
							...
							<div class="row">
									 ...
									 <div class="col-lg-7">
										<input name="email" type="text" class="form-control" id="email" placeholder="Em@il" value ="<?php   echo $row->email."  " ?>">   	 	
									</div>
							</div>
							...
							<div class="row">
									 ...
									 <div class="col-lg-7">
										<input name="guia" type="text" class="form-control" id="guia" placeholder="Guía Espiritual " value ="<?php   echo $row->guiaEspiritual."  " ?>">   	 	 	
									</div>
							</div>
							...
							<div class="row">
									 ...
									 <div class="col-lg-7">
										<input name="tiempo" type="text" class="form-control" id="tiempo" placeholder="Tiempo De Servicio Musical "  value ="<?php   echo $row->servMusical."  " ?>"> 	
									</div>
							</div>
							...
							<div class="row">
									 ...
									 <div class="col-lg-7">
										<input name="musica1" type="text" class="form-control" id="musica1" placeholder="Géneros Musicales"  value ="<?php   echo $row->Musical1."  " ?>">	
									</div>
							</div>
							<div class="row">
									 <div class="col-lg-3">
									 ...
									 <div class="col-lg-7">
										<input name="musica2" type="text" class="form-control" id="musica2" placeholder="Géneros Musicales" value ="<?php   echo $row->Musical2."  " ?>">	 	
									</div>
							</div>
						...
						<div class="row" >
						 ...
						 <div class="row">
                            <div class="form-group">
									<div class="col-lg-12">
										<textarea class="form-control" rows="5" id="message1" name="message1" maxlength="500"><?php   echo $row->Pregunta."" ?></textarea>
									</div>									
                            </div> 
			             </div> 
						  <!--
