                    ...
                    <div class="navbar navbar-default navbar-static-top" role="navigation">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
								...
								<li class="active"><a href="<?php echo site_url()?>razon"><b>Días en las Diócesis</b></a>
								 <ul class="dropdown-menu">
                                            <li><a href="<?php echo site_url()?>info_logo"><b>Logo de los DED Colón Kuna yala</b> </a></li>
											<li class="active"><a href="<?php echo site_url()?>parroquias"><b>Parroquias </b></a></li>
...
<section class="wrapper">
    ...
    <div  class="grey-content">		
            ...
            <div class="container">
                    ...
                    <div class="container">	
								<img class="img-responsive center-block" src="<?php echo base_url();?>images/paginas/parroquia.png" width="500" height="auto"/>
				</div>
