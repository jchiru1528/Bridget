    ...
    <div  class="grey-content">		
            ...
            <div class="container">
                ...
                <div class="templatemo-slogan text-center">
                    ...
                    <h1><P ALIGN=center><b>CAMPAÑA YO TE APOYO PEREGRINO<b>  </p> </h1>
					<P ALIGN=center>
						  <img src="<?php echo base_url();?>images/noticias/noticia_12.jpg" class="img-responsive" ALIGN=center alt="gallery" />
                     </p>
					<h4>
					 <h2  style="color:#fff" align="justify">
							Algunos de los frutos de la Jornada Mundial de la Juventud son: la renovación profunda de la Pastoral Juvenil en el país de acogida;
							las conversiones; la nueva seguridad que nuestros jóvenes han adquirido respecto a su fe; y el hecho de que los jóvenes se han 
							comprometido con nuevos tipos de servicios.          
                     </h2>
                      <h2  style="color:#fff" align="justify">
							Convencida de esta realidad, la Diócesis de Colón - Kuna Yala a través de la Pastoral Juvenil Diocesana, prepara a sus peregrinos
							locales para participar en la JMJ Panamá 2019, cuya proyección es conformar la Delegación Diocesana Oficial con 5,000 jóvenes de 
							todo el territorio diocesano, es decir, de las parroquias, comunidades, colegios y universidades.  

                     </h2>
					  <h2  style="color:#fff" align="justify">
							Para ello, conjunto con la Comisión Diocesana JMJ lanzan la Campaña Yo Te Apoyo Peregrino, con el objetivo de recaudar fondos para que 5,000 
							jóvenes de la Diócesis de Colón - Kuna Yala, puedan asistir a la Jornada Mundial de la Juventud a desarrollarse en 
							la Ciudad de Panamá del 22 al 27 de enero de 2019, contribuyendo con el pago de la inscripción del Paquete Modalidad 
							A1 de $230.00 por peregrino, que incluye Alojamiento, Alimentación, Transporte, Seguro y Kit de Peregrino.
                     </h2>
					  <h2  style="color:#fff" align="justify">
							Con el aporte voluntario de todos, los peregrinos locales tendrán la oportunidad de vivir una experiencia enriquecedora que los ayudará
							a fortalecer su fe, tener un intercambio social y cultural con el prójimo, y lo principal encontrarse con Jesús.
                    </h2>
					 <h2  style="color:#fff" align="justify">
							Pueden obtener sus sobres en la Parroquia más cercana o en la Oficina Diocesana JMJ, ubicada en la Ciudad de Colón, Calle 10 Avenida Central,
							Parroquia San José.
                     </h2>
					   <h2  style="color:#fff" align="justify">
							Ayúdanos a que la Pastoral Juvenil Diocesana esté en esta gran fiesta de la juventud junto al Santo Padre y a los jóvenes de todo el mundo.
                     </h2>
