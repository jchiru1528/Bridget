    ...
    <div  class="grey-content">		
            ...
            <div class="container">
                ...
                <div class="templatemo-slogan text-center">
                    ...
                    <h1><P ALIGN=center><b>Una Iglesia joven para los jóvenes<b>  </p> </h1>
					<P ALIGN=center>
						  <img src="<?php echo base_url();?>images/noticias/noticia_5.jpg" class="img-responsive" ALIGN=center alt="gallery" />
                     </p>
					<h4>
					<h2  style="color:#fff" align="justify">
							Del 17 al 19 de noviembre del 2017, el Consejo Diocesano de Pastoral Juvenil, Enlaces Parroquiales y la Comisión 
							Diocesana para la Jornada Mundial de la Juventud de la Diócesis de Colón - Kuna Yala, realizaron su retiro y
							planificación en el Centro de
							Formación María Estrella del Mar ubicado en la Cuasi parroquia de San Lorenzo Chagres, Costa Abajo de Colón
                     </h2>
                    <h2  style="color:#fff" align="justify">
							La primera jornada fue acompañada por una reflexión a la luz de la Palabra de Dios, sobre el trabajo de la 
							Pastoral Juvenil en la Diócesis, la misma estuvo a cargo del P. José Ortega. 
                     </h2>
				     
					  <h2  style="color:#fff" align="justify">
							El texto que acompañó el momento de reflexión bíblica (1Cor.3) hizo énfasis en descubrir puntos importantes como: 
                     </h2>
					 <h2  style="color:#fff" align="justify">
							Que nos enorgullece como cristianos, descubrir si nuestras actitudes y procesos contribuyen a la unidad y no a las 
							divisiones, y con qué material vamos construyendo nuestra Iglesia, es decir cuál es nuestro aporte en los espacios 
							vitales donde desarrollamos nuestro trabajo pastoral.  
                    </h2>
					<h2  style="color:#fff" align="justify">
							El segundo momento buscaba interpelar nuestra misión como agentes de pastoral camino hacia una pastoral juvenil revitalizada 
							que llegue a todos los espacios y realidades de la juventud y de la Iglesia en general para ello se puso en común en modo de 
							reflexión y dialogo el llamado del Papa Francisco en torno a la Jornada Mundial de los Pobres..  
                    </h2>
					<h2  style="color:#fff" align="justify">
							Como cierre la santa Eucaristía presidida por el Padre Norberto Ábrego asesor Diocesano y Nacional de la Pastoral Juvenil, 
							seguido por la evaluación del periodo 2017 y la presentación del calendario de actividades y de formaciones para el año 2018.   
                     </h2>
