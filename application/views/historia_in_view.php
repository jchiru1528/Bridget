                            ...
                            <ul class="nav navbar-nav">
								...
								<li class="active"><a href="<?php echo site_url()?>razon_in"><b>Days in the Dioceses</b></a>
									 <ul class="dropdown-menu">
												...
												<li class="active"><a href="<?php echo site_url()?>historia_in"><b>History of the Diocese</b>  </a></li>
									</ul>
                                </li>
...
<section class="wrapper">
    ...
    <div  class="grey-content">		
            ...
            <div class="container">
                <div class="container">	
					 <img class="img-responsive center-block" src="<?php echo base_url();?>images/paginas/historia-ing.png" width="500" height="auto"/>
			   </div> 
                ...
                <div class="templatemo-slogan text-center">
					...
					<h2  style="color:#fff" align="justify">
						<u><b>Brief historical review of the Diocese of Colon - Kuna Yala:</b></u>
                   </h2>
					<h2  style="color:#fff" align="justify">
