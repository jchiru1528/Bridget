                       ...
                       <div class="container" align="right">
						...
						<div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a a href="<?php echo site_url()?>jmj_in"><b>Home</b></a>
								   <ul class="dropdown-menu">
                                          <!--    <li class="active"><><b>Video Promocional De La Diócesis</b></a></li>-->
                                            <li class="active"><a href="<?php echo site_url()?>palabras_in"><b>Message from The bishop</b></a></li>                                         
                                        </ul>
                                 </li>
...
-->
    ...
    <div class="grey-content">
			...
			<div class="container">	
					 <img class="img-responsive center-block" src="<?php echo base_url();?>images/paginas/saludo-ing.png" width="500" height="auto"/>
					...
					&nbsp
						...
						<div class="row">
							...
							<div class="feature-block col-sm-7">
								...
								<h2  style="color:#fff" align="justify">
								Pope Francis has designated Panama as the site of the 2019 World Youth Day. The Pope comes to visit us, but he does not come alone. This festival of youth, 
								initiated by the beloved Pope St. John Paul II, gathers young people from all over the world, and we will be the hosts, with them we will share the Word and
								the same Encounter with the Lord Jesus Christ, we will celebrate our faith, we will share our longings and hopes, as well as the pain and the realities in 
								which we live, where war, indifference, selfishness, exclusion and injustice steal happiness. It is summoning us to renew our desire for a world as Jesus 
								thought where we all feel brothers.
 
								</h2>
							
							 
							 <h2  style="color:#fff" align="justify">
								2019 is near, and there are many things that need to be prepared, let us do our part, so that all who visit us can discover our church, our culture and traditions,
								our joy, and take a bit of us in their hearts.  I invite you all to get down to work, and raising your hands to God, let us pray for WYD Panama 2019.
							 </h2>
						...
						<div class="row">
								<h2  style="color:#fff" align="justify">
									To all those who think about coming, we already tell you that we are waiting for you. Our house will be your house. Our diocese on the shores of the
									beautiful Caribbean Sea, full of sun and the joy of our people, gives them the fraternal welcome of a beautiful land.
							 </h2>
							 <h2  style="color:#fff" align="justify">
									May the Lord bless you, and our Mother Mary guides you always. A hug to everyone.
							</h2>
							
							<h2  style="color:#fff" align="center">
									Bishop Manuel Ochogavía B. Osa
							</h2>
							<h2  style="color:#fff" align="center">
									Bishop of Columbus - Kuna Yala
							</h2>
