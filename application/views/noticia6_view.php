    ...
    <div  class="grey-content">		
            ...
            <div class="container">
                ...
                <div class="templatemo-slogan text-center">
                    ...
                    <h1><P ALIGN=center><b>VISITA DE LA DELEGACIÓN COLOMBIANA A LA OFICINA DIOCESANA JMJ<b>  </p> </h1>
					<P ALIGN=center>
						  <img src="<?php echo base_url();?>images/noticias/noticia_6.png" class="img-responsive" ALIGN=center alt="gallery" />
                     </p>
					<h4>
					<h2  style="color:#fff" align="justify">
							En días pasados una Comisión del Instituto de Jesús Adolescente de la Arquidiócesis de Bogotá Colombia, visitó las oficinas de 
							la Jornada Mundial de la Juventud de la Diócesis de Colón - Kuna Yala, ubicada en la Parroquia San José, Calle 10 Avenida Central, 
							Provincia de Colón.  Fueron recibidos por el joven  Yeison Sánchez, de la Comisión Diocesana JMJ; se les presentó el programa general
							de los Días en la Diócesis que inicia el 14 y finaliza el 21 de enero del 2019.   Se hizo énfasis que los Días en la Diócesis serán 
							dedicados a la misión, en donde el peregrino podrá llegar a las comunidades más necesitadas, atravesando ríos, lagos, usando caballo y 
							otros medios, ya que contamos con muchas islas y lugares de difícil acceso en nuestro territorio Diocesano, además de las áreas
							urbanas y suburbanas de Colón.
                     </h2>
                    <h2  style="color:#fff" align="justify">
							Por su parte el Padre Carlos Iván Martínez Director del Instituto, agradeció la acogida y manifestó la intención de poder traer una delegación
							de 400 personas e hizo una invitación a la Comisión Diocesana JMJ para visitar a Colombia en el mes de agosto, con la intención de intercambiar 
							información sobre los Días en la Diócesis de Colón - Kuna Yala y motivar a los jóvenes a que participen.
                     </h2>
				     
					  <h2  style="color:#fff" align="justify">
							Nuestra Diócesis, ha recibido muchas solicitudes de parte de muchas  delegaciones extranjeras, para participar en nuestros Días en la Diócesis,
							quienes manifiestan su deseo de misionar y tener una experiencia de crecimiento espiritual y cultural.
                     </h2>
					 <h2  style="color:#fff" align="justify">
							La Comisión Diocesana JMJ se prepara día con día para que la acogida de estos peregrinos sea una experiencia edificante y de mucho
							fruto.


                    </h2>
					<h2  style="color:#fff" align="justify">
							Lo invitamos a visitar nuestra página web www.colonkuna2019.com, en donde podrán encontrar más información de nuestro Días en la Diócesis (DED).
                    </h2>
