    ...
    <div  class="grey-content">		
            ...
            <div class="container">
                ...
                <div class="templatemo-slogan text-center">
                    ...
                    <h1><P ALIGN=center><b>La JMJ se hace presente el 5 de Noviembre<b>  </p> </h1>
					<P ALIGN=center>
						  <img src="<?php echo base_url();?>images/noticias/noticia_3.jpeg" class="img-responsive" ALIGN=center alt="gallery" />
                     </p>
					<h4>
					<h2  style="color:#fff" align="justify">
							Dentro de la celebración patriótica en conmemoración a la Consolidación de la Gesta Separatista del 3 de noviembre,
							donde se reafirma la soberanía del país en Colón, una delegación del Equipo de la Diócesis de Colón - Kuna Yala 
							para la JMJ Panamá 2019, marchó en el tradicional desfile del 5 de noviembre en la provincia de Colón. 
                     </h2>
                     <h2  style="color:#fff" align="justify">
							Con mucha alegría salieron estos jóvenes colonenses a recorrer sus calles para honrar a su patria y a la vez sensibilizar 
							a la población. Vestidos de peregrinos, acompañados de banderas y de los vistosos colores de los atuendos típicos de la 
							región, recorrieron la ruta del desfile desde calle 13 hasta el sector de los 4 altos. Coreando los cánticos de la Jornada
							Mundial, como el himno de la misma, entre otros, se ganaron el cariño y los aplausos de la gente. 
                     </h2>
					 
					  <h2  style="color:#fff" align="justify">
							De igual forma algunos voluntarios realizaron entregas de volantes con información relevante a la jornada y tomaron 
							fotografías a los presentes para promocionar sus redes sociales @colonkunaenjmj
                     </p>
